...
All of the py files can be executed by clicking, but in case an error comes up,
you can run them by opening the CMD, navigating to the project's folder, and running:
python [file].
You can interrupt any execution by pressing CTRL + C in the cmd window.